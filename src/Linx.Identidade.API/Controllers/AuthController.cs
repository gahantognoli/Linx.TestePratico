...
using Linx.Identidade.API.Models;
...
namespace Linx.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            {
                AdicionarErroProcessamento("Usuário temporariamente bloqueado por tentátivas inválidas");
                return CustomResponse();
            }
